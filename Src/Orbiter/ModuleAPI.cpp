...
void Module::clbkSimulationStart (RenderMode mode)
{
	...
	void (*opcOpenRenderViewport)(HWND,DWORD,DWORD,BOOL) = (void(*)(HWND,DWORD,DWORD,BOOL))DLL::GetProcAddress (hModule, "opcOpenRenderViewport");
...
{
	// backward compatibility call (deprecated)
	void (*opcCloseRenderViewport)() = (void(*)())DLL::GetProcAddress (hModule, "opcCloseRenderViewport");
...
{
	// backward compatibility call (deprecated)
	void (*opcPreStep)(double,double,double) = (void(*)(double,double,double))DLL::GetProcAddress (hModule, "opcPreStep");
...
{
	// backward compatibility call (deprecated)
	void (*opcPostStep)(double,double,double) = (void(*)(double,double,double))DLL::GetProcAddress (hModule, "opcPostStep");
...
{
	// backward compatibility call (deprecated)
	void (*opcFocusChanged)(OBJHANDLE,OBJHANDLE) = (void(*)(OBJHANDLE,OBJHANDLE))DLL::GetProcAddress (hModule, "opcFocusChanged");
...
{
	// backward compatibility call (deprecated)
	void (*opcTimeAccChanged)(double,double) = (void(*)(double,double))DLL::GetProcAddress (hModule, "opcTimeAccChanged");
...
{
	// backward compatibility call (deprecated)
	void (*opcDelVessel)(OBJHANDLE) = (void(*)(OBJHANDLE))DLL::GetProcAddress (hModule, "opcDeleteVessel");
...
{
	// backward compatibility call (deprecated)
	void (*opcPause)(bool) = (void(*)(bool))DLL::GetProcAddress (hModule, "opcPause");
